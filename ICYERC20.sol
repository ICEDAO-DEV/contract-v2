...
contract ICYERC20Token is ERC20Permit, VaultOwned {
    using SafeMath for uint256;

    // safeMoon: 10% reflected to new bond buyer /10000
    uint256 public num;
    ...
    function setWhiteListed(address _white, bool tOrF)
        external
        onlyOwner
        returns (bool)
    {
    ...
    function setBoundReward(address _boundReward)
        external
        onlyOwner
        returns (bool)
    {
    ...
    function setBlackListed(address white, bool tOrF)
        external
        onlyOwner
        returns (bool)
    {
